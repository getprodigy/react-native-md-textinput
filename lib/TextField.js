...
export default class TextField extends Component {
  ...
  componentWillReceiveProps(nextProps: Object){
    ...
    if (this.hasPlaceholder(nextProps.placeholder)) {
      this.refs.floatingLabel.floatLabel();
    }
  }
  componentDidMount() {
    if (this.hasPlaceholder(this.props.placeholder)) {
      this.refs.floatingLabel.floatLabel();
    }
  }
      ...
      <View style={[dense ? styles.denseWrapper : styles.wrapper, wrapperStyle]} ref="wrapper">
        <TextInput
          ...
          onBlur={() => {
            ...
            (!this.state.text.length && !this.props.placeholder.length) && this.refs.floatingLabel.sinkLabel();
